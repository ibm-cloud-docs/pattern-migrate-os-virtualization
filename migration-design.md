...
![Migrate VMWare to IBM Cloud Openshift Virtualization Phases](images/mw2ibmcloudocpvmigration.svg){: caption="Migrate VMWare workloads to IBM Cloud Openshift Virtualization Phased approach" caption-side="bottom"}
