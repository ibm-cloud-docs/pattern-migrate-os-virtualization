...
-   **Maintain workload and management network segregation:** To preserve existing workload compliance boundaries and management segmentation, the Openshift Virtualization clusters can be deployed into IBM Cloud VPCs that mirror existing production and non-production network segregation. This approach allows for regulatory and operational controls - such that tenant isolation is maintained.
