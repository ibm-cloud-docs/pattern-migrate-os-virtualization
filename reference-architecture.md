...
|                    | Descheduler operator                                               | With live migration provides dynamic resource balancing of CPU RAM resources across the worker pool to optimize compute utilisation.                                                                                                              |
