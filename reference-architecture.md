...
| Networking         | Maintain existing VMware network segregation and vLans \\n Provide separate networks for storage, management, live migration, workload  \\n Provide DNS resolution across virtual and container instances \\n Provide that application network changes are not required.                                                                                                                                                                                                                                                                                                                                 |
