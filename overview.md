...
The objective of this pattern is to provide an {{site.data.keyword.IBM_notm}} solution design and deployment guide for the usage of OpenShift virtualization to migrate existing virtual machine workloads into IBM Cloud.
...
Migrating to OpenShift virtualization provides the following benefits:
